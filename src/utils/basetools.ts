 ...
 */
export function base58BitcoinEncode(bytes: Uint8Array): string {
 ...
 */
export function base58BitcoinDecode(str: string): Uint8Array {
 ...
 */
export function base32rfcEncode(data: Uint8Array): string {
  let result = '';
  let bits = 0;
  let value = 0;
 ...
 */
export function base32rfcDecode(encoded: string): Uint8Array {
